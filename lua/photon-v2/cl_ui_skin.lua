...
surface.CreateFont("PhotonDefault", {
	font = "Arial",
	-- font = "Segoe UI",
	size = 16
})
...
SKIN.Author		= "Schmal"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "photon/ui/skin_studio.png" )
SKIN.ID = SkinID
...
SKIN.fontCategoryHeader			= "PhotonDefault"
...
SKIN.tex.Panels.NormalTop			= GWEN.CreateTextureBorder( 256,	0, 63, 59, 16, 16, 16, 0 )
SKIN.tex.Panels.NormalMid			= GWEN.CreateTextureBorder( 256,	4, 63, 55, 16, 0, 16, 0 )
SKIN.tex.Panels.NormalLow			= GWEN.CreateTextureBorder( 256,	4, 63, 59, 16, 0, 16, 16 )
...
SKIN.tex.Scroller.LeftButton_Normal		= GWEN.CreateTextureBorder( 464,		208, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.LeftButton_Hover		= GWEN.CreateTextureBorder( 480,		208, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.LeftButton_Down		= GWEN.CreateTextureBorder( 464,		272, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.LeftButton_Disabled	= GWEN.CreateTextureBorder( 480 + 48,	272, 16, 16, 2, 2, 2, 2 )

SKIN.tex.Scroller.UpButton_Normal		= GWEN.CreateTextureBorder( 464,		208 + 16, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.UpButton_Hover		= GWEN.CreateTextureBorder( 480,		208 + 16, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.UpButton_Down			= GWEN.CreateTextureBorder( 464,		272 + 16, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.UpButton_Disabled		= GWEN.CreateTextureBorder( 480 + 48,	272 + 16, 16, 16, 2, 2, 2, 2 )

SKIN.tex.Scroller.RightButton_Normal	= GWEN.CreateTextureBorder( 464,		208 + 32, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.RightButton_Hover		= GWEN.CreateTextureBorder( 480,		208 + 32, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.RightButton_Down		= GWEN.CreateTextureBorder( 464,		272 + 32, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.RightButton_Disabled	= GWEN.CreateTextureBorder( 480 + 48,	272 + 32, 16, 16, 2, 2, 2, 2 )

SKIN.tex.Scroller.DownButton_Normal		= GWEN.CreateTextureBorder( 464,		208 + 48, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.DownButton_Hover		= GWEN.CreateTextureBorder( 480,		208 + 48, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.DownButton_Down		= GWEN.CreateTextureBorder( 464,		272 + 48, 16, 16, 2, 2, 2, 2 )
SKIN.tex.Scroller.DownButton_Disabled	= GWEN.CreateTextureBorder( 480 + 48,	272 + 48, 16, 16, 2, 2, 2, 2 )
...
SKIN.tex.ActionBar = {}
SKIN.tex.ActionBar.Float = GWEN.CreateTextureBorder(384, 464, 16, 16, 4, 4, 4, 4)
SKIN.tex.ActionBar.Bottom = GWEN.CreateTextureBorder(401, 464, 16, 16, 4, 4, 4, 4)
SKIN.tex.ActionBar.Top = GWEN.CreateTextureBorder(418, 464, 16, 16, 4, 4, 4, 4)
SKIN.tex.ActionBar.Span = GWEN.CreateTextureBorder(386, 464, 12, 16, 4, 4, 4, 4)
...
function SKIN:PaintPanel( panel, w, h )
	...
	self.tex.Panels[panel.Style or "Normal"]( 0, 0, w, h, panel.m_bgColor )
...
function SKIN:PaintWindowRestoreButton( panel, w, h )

	if ( !panel.m_bBackground ) then return end

	if ( panel:GetDisabled() ) then
		return self.tex.Window.Restore( 0, 0, w, h, Color( 255, 255, 255, 50 ) )
	end
	...
	self.tex.Window.Restore( 0, 0, w, h )
...
local nodeLevel, nodeIndent, drawX
function SKIN:PaintTreeNodeButton( panel, w, h )
	-- if not panel.treeRoot then
		
	-- end
	DisableClipping(true)
	nodeLevel = panel:GetParent().NodeLevel - 1
	nodeIndent = panel:GetParent():GetIndentSize()
	-- panel:NoClipping(true)
	if panel.m_bSelected then
		surface.SetDrawColor(0, 150, 255, 99)
		surface.DrawRect(-(nodeLevel * nodeIndent), 0, w + (nodeLevel * nodeIndent), h)
	elseif panel.Hovered then
		surface.SetDrawColor(0, 200, 255, 33)
		surface.DrawRect(-(nodeLevel * nodeIndent), 0, w + (nodeLevel * nodeIndent), h)
	end
	DisableClipping(false)
	...
	-- self.tex.Selection( 16, 0, w - 17, h )
...
function SKIN:PaintFormProperty(panel, w, h)

end

function SKIN:PaintActionBar(panel, w, h)
	self.tex.ActionBar[panel.Placement](0, 0, w, h, Color(255, 255, 255))
end
...
function SKIN:PaintPListViewLine( panel, w, h )
	print("working")
	self.tex.Input.ListBox.Hovered( 0, 0, w, h )
end
...
function SKIN:PaintMenuBarTitle(panel, w, h)
-- 	if true then return end
	-- if not IsValid(panel) then return end
	-- if not panel:GetParent() then return end
	if panel.Depressed or ((panel:GetParent():GetOpenMenu() and panel:GetParent():GetOpenMenu().m_PrimaryHeader == panel)) then
	...
	surface.DrawRect(1, 0, w - 1, h - 1)
end

derma.DefineSkin( SkinID, "Designed for Photon Studio.", SKIN )
