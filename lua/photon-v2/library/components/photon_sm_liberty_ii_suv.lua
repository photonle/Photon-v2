...
COMPONENT.Templates = {
	["2D"] = {
		...
		Takedown = {
			Width 	= 7.4,
			Height	= 7,
			Shape = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sm_whe_lib_ii_6x2_shape.png").MaterialName,
			Detail = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sm_whe_lib_ii_6x2_detail.png").MaterialName,
