...
COMPONENT.Name = "photon_c3_rx2700_47"
...
COMPONENT.Base = "photon_c3_rx2700_47"
COMPONENT.Name = "photon_c3_rx2700_52"
COMPONENT.Title = "Code 3 RX2700 (52\")"
COMPONENT.Model = "models/schmal/code3_rx2700_52.mdl"

COMPONENT.Elements = {
	[1] = { "Linear", Vector( 6.62, 1.75, -1.36 ), Angle( 0, -90, 180 ), RequiredBodyGroups = { ["Middle"] = 1 } },
	[2] = { "Linear", Vector( 6.62, -1.75, -1.36 ), Angle( 0, -90, 0 ), RequiredBodyGroups = { ["Middle"] = 1 } },

	[3] = { "Linear", Vector( 6.62, 12.75, -1.36 ), Angle( 0, -90, 0 ) },
	[4] = { "Linear", Vector( 6.62, -12.75, -1.36 ), Angle( 0, -90, 0 ) },

	[5] = { "Linear", Vector( 6.62, 19.64, -1.36 ), Angle( 0, -90, 0 ) },
	[6] = { "Linear", Vector( 6.62, -19.64, -1.36 ), Angle( 0, -90, 0 ) },

	[7] = { "Linear", Vector( 4.25, 26.4, -1.36 ), Angle( 0, -90 + 45, 0 ) },
	[8] = { "Linear", Vector( 4.25, -26.4, -1.36 ), Angle( 0, -90 - 45, 0 ) },

	[9] = { "Linear", Vector( -4.25, 26.4, -1.36 ), Angle( 0, 90 - 45, 0 ) },
	[10] = { "Linear", Vector( -4.25, -26.4, -1.36 ), Angle( 0, 90 + 45, 0 ) },

	[11] = { "Linear", Vector( -6.62, 19.64, -1.36 ), Angle( 0, 90, 0 ) },
	[12] = { "Linear", Vector( -6.62, -19.64, -1.36 ), Angle( 0, 90, 0 ) },

	[13] = { "Linear", Vector( -6.62, 12.75, -1.36 ), Angle( 0, 90, 0 ) },
	[14] = { "Linear", Vector( -6.62, -12.75, -1.36 ), Angle( 0, 90, 0 ) },

	[15] = { "Linear", Vector( -6.62, 4.45, -1.36 ), Angle( 0, 90, 0 ) },
	[16] = { "Linear", Vector( -6.62, -4.45, -1.36 ), Angle( 0, 90, 180 ) },

	[17] = { "Takedown", Vector( 5.9, 4.5, -1.35 ), Angle( 0, -90, 0 ), RequiredBodyGroups = { ["Middle"] = 0 } },
	[18] = { "Takedown", Vector( 5.9, -4.5, -1.35 ), Angle( 0, -90, 0 ), RequiredBodyGroups = { ["Middle"] = 0 } },

	[19] = { "Takedown", Vector( 0, 27.8, -1.35 ), Angle( 0, 0, 0 ) },
	[20] = { "Takedown", Vector( 0, -27.8, -1.35 ), Angle( 0, 180, 0 ) },
