...
COMPONENT.Elements = {
	...
	[11] = { "Main", Vector( -8.6, 4.1, 1.35 ), Angle( 0, 90, 0 ), RequiredBodyGroups = { ["rear_inner"] = 0 } },
	[12] = { "Main", Vector( -8.6, -4.02, 1.35 ), Angle( 0, 90, 0 ), RequiredBodyGroups = { ["rear_inner"] = 0 } },
	...
	[15] = { "Main", Vector( -8.6, 20.1, 1.35 ), Angle( 0, 90, 0 ), RequiredBodyGroups = { ["rear_outer"] = 0 } },
	[16] = { "Main", Vector( -8.6, -20.04, 1.35 ), Angle( 0, 90, 0 ), RequiredBodyGroups = { ["rear_outer"] = 0 } },
...
COMPONENT.Segments = {
	...
	ALT_REAR = {
		...
		Sequences = {
			["ON"] = {
				1,1,2,2,3,4,5,2,6,7,8,9,10,11,7,9,9,12,9,9,9,12,13,14,15,16,17,16,18,16,17,17,19,20,16,21,22,20,23,23,24,24,23,23,23,24,25,26,27
			},
		}
	},
	ALT_FRONT = {
