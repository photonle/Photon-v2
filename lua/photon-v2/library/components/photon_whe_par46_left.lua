...
COMPONENT.Templates = {
	["2D"] = {
		Light = {
			Shape = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_par46_shape.png").MaterialName,
			Detail = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_par46_detail.png").MaterialName,
			Width = 7.6,
			Height = 7.6,
			Scale = 2
		}
