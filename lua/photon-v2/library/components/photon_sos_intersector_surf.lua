...
COMPONENT.Templates = {
	["2D"] = {
		LED_Main = {
			Shape = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/led_shape.png").MaterialName,
			Detail = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/led_detail.png").MaterialName,
			Width = 0.5,
			Height = 0.5,
			Scale = 1.3,
			VisibilityRadius = 0
