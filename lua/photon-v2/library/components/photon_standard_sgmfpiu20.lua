...
COMPONENT.Templates = {
	["2D"] = {
		...
		Brake = {
			Width = 11.2,
			Height = 1.8,
			Material = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_brake_shape.png").MaterialName,
			MaterialOverlay = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_brake_detail.png").MaterialName,
		...
		Marker = {
			Width = 3.2,
			Height = 3.2,
			Material = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_marker_shape.png").MaterialName,
			MaterialOverlay = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_marker_detail.png").MaterialName,
		...
		Park = {
			Width = 5,
			Height = 1.5,
			Material = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_park_shape.png").MaterialName,
			MaterialOverlay = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_park_detail.png").MaterialName,
		...
		Headlight = {
			Width = 6.8,
			Height = 3.4,
			Material = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_headlight_shape.png").MaterialName,
			MaterialOverlay = PhotonDynamicMaterial.GenerateLightQuad("photon/lights/sgm_fpiu20_headlight_detail.png").MaterialName,
