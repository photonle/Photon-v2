...
---@class BoneManipulationData (Struct)
...
---@class PhysEnvPerformanceSettings (Struct)
...
---@class PhysicsObjectSave (Struct)
...
---@field StructureField number Where in the list should the property be positioned, relative to other properties.  For reference, here are the default properties and their Order values:  Property |  Order | ---------|-------| | Bone Manipulate | 500 | | Bodygroups | 600 | | Skin | 601 | | Keep Upright | 900 | | Ignite/Extinguish | 999 | | Remove | 1000 | | Gravity | 1001 | | Drive | 1100 | | Collision | 1500 | | Statue | 1501 | | NPC Biggify/Smallify | 1799, 1800 | | Motion Control (Kinect) | 2500 | | Editable_Entities | 90001 |
...
---@class RenderCaptureData (Struct)
...
---@class SurfacePropertyData (Struct)
...
---@field Weapon Weapon Deprecated, use `SWEP` instead. However, if called in a method; use `self` instead.
...
---@class VehicleParamsAxle (Struct)
...
---@class VehicleParamsBody (Struct)
...
---@class VehicleParamsEngine (Struct)
...
---@field boostMaxSpeed number Maximum speed while boosting  The Vehicle:SetVehicleParams function takes this in **miles per hour**, but Vehicle:GetVehicleParams returns this in **hammer units per second**!  1 MPH is roughly 17.6 HU/s.
...
---@field maxRevSpeed number Maximum reverse speed of the vehicle  The Vehicle:SetVehicleParams function takes this in **miles per hour**, but Vehicle:GetVehicleParams returns this in **hammer units per second**!  1 MPH is roughly 17.6 HU/s.
---@field maxSpeed number Maximum forward going speed of the vehicle without boosting  The Vehicle:SetVehicleParams function takes this in **miles per hour**, but Vehicle:GetVehicleParams returns this in **hammer units per second**!  1 MPH is roughly 17.6 HU/s.
...
---@class VehicleParamsSteering (Struct)
